...
Процедура ПриЗаполненииПоставляемыхПрофилейГруппДоступа(ОписанияПрофилей, ПараметрыОбновления) Экспорт
	...
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Имя           = "ВКМ Бухгалтер ИТ фирмы";
	ОписаниеПрофиля.Идентификатор = "4bba6e62-a175-11f0-b620-141333528254";
	...
	ОписаниеПрофиля.Роли.Добавить("ДобавлениеИзменениеНСИ");
	ОписаниеПрофиля.Роли.Добавить("ДобавлениеИзменениеДокументовПродажи");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ПросмотрОбслуживание");
	...
	ОписаниеПрофиля.Роли.Добавить("ВКМ_Просмотр");
	
	ОписанияПрофилей.Добавить(ОписаниеПрофиля);
	
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Имя           = "ВКМ Специалист";
	ОписаниеПрофиля.Идентификатор = "4bba6e61-a175-11f0-b620-141333528254";
	...
	ОписаниеПрофиля.Роли.Добавить("БазоваяФункциональностьТП");
	ОписаниеПрофиля.Роли.Добавить("ДобавлениеИзменениеНСИ");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ДобавлениеИзменениеДокументОбслуживаниеКлиента");
	...
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Имя           = "ВКМ Менеджер";
	ОписаниеПрофиля.Идентификатор = "4bba6e60-a175-11f0-b620-141333528254";
	...
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Имя           = "ВКМ Кадровик расчетчик";
	ОписаниеПрофиля.Идентификатор = "4bba6e5f-a175-11f0-b620-141333528254";
	...
	ОписаниеПрофиля.Роли.Добавить("БазоваяФункциональностьТП");
	ОписаниеПрофиля.Роли.Добавить("ДобавлениеИзменениеНСИ");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ДобавлениеИзменениеДокументВыплатаЗарплаты");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ДобавлениеИзменениеДокументГрафикОтпусков");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ДобавлениеИзменениеДокументНачислениеФиксПремии");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ДобавлениеИзменениеДокументНачислениеЗарплаты");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ДобавлениеИзменениеСправочникВидыГрафиковРабот");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ДобавлениеИзменениеСправочникСотрудники");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ИспользованиеОбработкиЗаполнениеГрафиковРабот");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ИспользованиеОтчетаРасчетыССотрудниками");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ИспользованиеОтчетаРасчетОтпусков");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ИспользованиеОтчетаВыработкаСпециалистов"); 
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ПросмотрРасчетПлаты"); 
	ОписаниеПрофиля.Роли.Добавить("ВКМ_Просмотр");
